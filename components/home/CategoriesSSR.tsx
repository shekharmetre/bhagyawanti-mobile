...
export default function CategoriesSSR() {
  return (
    <>
      {/* Desktop Version */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 hidden md:block">
      ...
      {/* Mobile Version */}
      <section className="px-4 py-8 md:py-12 md:hidden">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center lg:text-left">
            Categories
          </h3>

          <div className="grid grid-cols-3 gap-4 md:gap-8 lg:gap-12 max-w-2xl mx-auto lg:mx-0">
