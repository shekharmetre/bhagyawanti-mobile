...
export function HorizontalShopCard({ allProducts }: { allProducts: ShopData[] }) {
  ...
  function ScheduleVisit() {
    openModal(
      <RepairSchedulingModal onClose={closeModal} isOpen={true} selectedDevice={{brand:"realme",modelName:"Realme C1",repairType:"Screen Repair"}} shopDetail={selectedShopId} />
    );
  }
  ...
  return (
    ...
    >
      <div className="col-span-full mt-10 flex justify-between items-start mb-4">
